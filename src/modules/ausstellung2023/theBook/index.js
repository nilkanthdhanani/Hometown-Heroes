                ...
                <div className="the-book">
                    <div className="the-book-div">
                        ...
                        <div className="the-book-div-text">
                            ...
                            <p>Each purchase supports organizations on the ground, making a real impact in the lives we capture.</p>
                            <p>This is just the beginning. For every Hometown Heroes edition in the future, there will be a corresponding photobook—a captivating coffee table book. </p>
