...
export default function Lebanon() {
    return (
        <>
            <div className="lebanon">
                <div className="container4">
                    <div className="lebanon-div">
                        <div className="lebanon-text">
                            <p>NOVEMBER 2023 <br /> In November, Hometown Heroes embarks on a transformative journey to Lebanon. Our three-week mission is more than just a trip; it's a commitment to stand with those who have faced immense adversity. </p>
